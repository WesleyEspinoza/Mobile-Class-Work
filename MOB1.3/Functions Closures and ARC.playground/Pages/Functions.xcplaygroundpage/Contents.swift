...
//write the function here
func printAllGuests(_ guests: [Guest]){
...
//write the function here
func guestsOver18(arr: [Guest]) -> [Guest]{
    return arr.filter {$0.age >= 18}
}
...
guestsOver18(arr: invitedGuests)
/*:
...
let numOfCustomers = Customer.getNumberOfCustomers()
